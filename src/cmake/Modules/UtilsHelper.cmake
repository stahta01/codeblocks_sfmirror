...
# install script
#------------------------------------
macro(codeblocks_install_script _script_)
    set (EXE_PERM OWNER_EXECUTE OWNER_WRITE OWNER_READ GROUP_EXECUTE GROUP_READ WORLD_EXECUTE WORLD_READ)
    install(FILES ${_script_} DESTINATION ${CB_PREFIX}/bin PERMISSIONS ${EXE_PERM})
endmacro()
...
macro(codeblocks_add_exported_pch _TARGET_)
...
macro(codeblocks_add_pch _TARGET_)
    target_precompile_headers(
        ${_TARGET_} 
    PRIVATE
        ${PCH_HEADERS_LIST}
