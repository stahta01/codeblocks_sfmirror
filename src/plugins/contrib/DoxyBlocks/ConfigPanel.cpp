    ...
    m_pOwnerClass(pOwner)
{
    ...
    TextCtrlBlockComment = new cbStyledTextCtrl(StaticBoxSizer1->GetStaticBox(),ID_TEXTCTRL_BLOCKCOMMENT,wxDefaultPosition,wxDefaultSize);
    ...
    TextCtrlLineComment = new cbStyledTextCtrl(StaticBoxSizer3->GetStaticBox(),ID_TEXTCTRL_LINECOMMENT,wxDefaultPosition,wxDefaultSize);
    ...
    StaticText1 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), wxID_ANY, _("PROJECT_NUMBER"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
    BoxSizer5->Add(StaticText1, 0, wxTOP|wxBOTTOM|wxLEFT|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlProjectNumber = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL_PROJECTNUMBER, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PROJECTNUMBER"));
    ...
    CheckBoxUseAutoVersion = new wxCheckBox(StaticBoxSizer2->GetStaticBox(), ID_CHECKBOX_USEAUTOVERSION, _("Use AutoVersion"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_USEAUTOVERSION"));
    ...
    StaticText8 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), wxID_ANY, _("OUTPUT_DIRECTORY"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
    BoxSizer18->Add(StaticText8, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlOutputDirectory = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRLOUTPUT_DIRECTORY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRLOUTPUT_DIRECTORY"));
    ...
    StaticText5 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT5, _("OUTPUT_LANGUAGE"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
    BoxSizer20->Add(StaticText5, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    ChoiceOutputLanguage = new wxChoice(StaticBoxSizer2->GetStaticBox(), ID_CHOICE_OUTPUT_LANGUAGE, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE_OUTPUT_LANGUAGE"));
    ...
    StaticBoxSizer5 = new wxStaticBoxSizer(wxVERTICAL, Panel3, _("Build"));
    CheckBoxExtractAll = new wxCheckBox(StaticBoxSizer5->GetStaticBox(), ID_CHECKBOX_EXTRACT_ALL, _("EXTRACT_ALL"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_EXTRACT_ALL"));
    ...
    CheckBoxExtractPrivate = new wxCheckBox(StaticBoxSizer5->GetStaticBox(), ID_CHECKBOX_EXTRACTPRIVATE, _("EXTRACT_PRIVATE"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_EXTRACTPRIVATE"));
    ...
    CheckBoxExtractStatic = new wxCheckBox(StaticBoxSizer5->GetStaticBox(), ID_CHECKBOX_EXTRACTSTATIC, _("EXTRACT_STATIC"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_EXTRACTSTATIC"));
    ...
    CheckBoxWarnings = new wxCheckBox(StaticBoxSizer10->GetStaticBox(), ID_CHECKBOX_WARNINGS, _("WARNINGS"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_WARNINGS"));
    ...
    CheckBoxWarnIfDocError = new wxCheckBox(StaticBoxSizer10->GetStaticBox(), ID_CHECKBOX_WARN_IF_DOC_ERROR, _("WARN_IF_DOC_ERROR"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_WARN_IF_DOC_ERROR"));
    ...
    CheckBoxWarnIfUndocumented = new wxCheckBox(StaticBoxSizer10->GetStaticBox(), ID_CHECKBOX_WARN_IF_UNDOCUMENTED, _("WARN_IF_UNDOCUMENTED"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_WARN_IF_UNDOCUMENTED"));
    ...
    CheckBoxWarnNoParamdoc = new wxCheckBox(StaticBoxSizer10->GetStaticBox(), ID_CHECKBOX_WARN_NO_PARAMDOC, _("WARN_NO_PARAMDOC"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_WARN_NO_PARAMDOC"));
    ...
    CheckBoxAlphabeticalIndex = new wxCheckBox(StaticBoxSizer6->GetStaticBox(), ID_CHECKBOX_ALPHABETICAL_INDEX, _("ALPHABETICAL_INDEX"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_ALPHABETICAL_INDEX"));
    ...
    CheckBoxGenerateHTML = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_HTML, _("GENERATE_HTML"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_HTML"));
    ...
    CheckBoxGenerateHTMLHelp = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_HTMLHELP, _("GENERATE_HTMLHELP"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_HTMLHELP"));
    ...
    CheckBoxGenerateCHI = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_CHI, _("GENERATE_CHI"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_CHI"));
    ...
    CheckBoxBinaryTOC = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_BINARY_TOC, _("BINARY_TOC"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_BINARY_TOC"));
    ...
    CheckBoxGenerateLatex = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_LATEX, _("GENERATE_LATEX"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_LATEX"));
    ...
    CheckBoxGenerateRTF = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_RTF, _("GENERATE_RTF"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_RTF"));
    ...
    CheckBoxGenerateMan = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_MAN, _("GENERATE_MAN"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_MAN"));
    ...
    CheckBoxGenerateXML = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_XML, _("GENERATE_XML"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_XML"));
    ...
    CheckBoxGenerateAutogenDef = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_AUTOGEN_DEF, _("GENERATE_AUTOGEN_DEF"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_AUTOGEN_DEF"));
    ...
    CheckBoxGeneratePerlMod = new wxCheckBox(StaticBoxSizer7->GetStaticBox(), ID_CHECKBOX_GENERATE_PERLMOD, _("GENERATE_PERLMOD"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_GENERATE_PERLMOD"));
    ...
    CheckBoxEnablePreprocessing = new wxCheckBox(StaticBoxSizer8->GetStaticBox(), ID_CHECKBOX_ENABLE_PREPROCESSING, _("ENABLE_PREPROCESSING"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_ENABLE_PREPROCESSING"));
    ...
    BoxSizer16->Add(StaticBoxSizer8, 0, wxALIGN_LEFT, 5);
    StaticBoxSizer9 = new wxStaticBoxSizer(wxVERTICAL, Panel4, _("Dot"));
    CheckBoxClassDiagrams = new wxCheckBox(StaticBoxSizer9->GetStaticBox(), ID_CHECKBOX_CLASS_DIAGRAMS, _("CLASS_DIAGRAMS"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_CLASS_DIAGRAMS"));
    ...
    CheckBoxHaveDot = new wxCheckBox(StaticBoxSizer9->GetStaticBox(), ID_CHECKBOX_HAVE_DOT, _("HAVE_DOT"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_HAVE_DOT"));
    ...
    BoxSizer16->Add(StaticBoxSizer9, 0, wxALIGN_LEFT, 5);
    ...
    StaticText2 = new wxStaticText(StaticBoxSizer4->GetStaticBox(), ID_STATICTEXT2, _("Path To doxygen"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    BoxSizer8->Add(StaticText2, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPathDoxygen = new wxTextCtrl(StaticBoxSizer4->GetStaticBox(), ID_TEXTCTRL_PATHDOXYGEN, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PATHDOXYGEN"));
    ...
    ButtonBrowseDoxygen = new wxButton(StaticBoxSizer4->GetStaticBox(), ID_BUTTON_BROWSEDOXYGEN, _("Browse"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_BROWSEDOXYGEN"));
    ...
    StaticText4 = new wxStaticText(StaticBoxSizer4->GetStaticBox(), ID_STATICTEXT4, _("Path To doxywizard"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
    BoxSizer9->Add(StaticText4, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPathDoxywizard = new wxTextCtrl(StaticBoxSizer4->GetStaticBox(), ID_TEXTCTRL_PATHDOXYWIZARD, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PATHDOXYWIZARD"));
    ...
    ButtonBrowseDoxywizard = new wxButton(StaticBoxSizer4->GetStaticBox(), ID_BUTTON_BROWSEDOXYWIZARD, _("Browse"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_BROWSEDOXYWIZARD"));
    ...
    StaticText3 = new wxStaticText(StaticBoxSizer4->GetStaticBox(), ID_STATICTEXT3, _("Path To HHC"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    BoxSizer3->Add(StaticText3, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPathHHC = new wxTextCtrl(StaticBoxSizer4->GetStaticBox(), ID_TEXTCTRL_PATHHHC, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PATHHHC"));
    ...
    ButtonBrowseHHC = new wxButton(StaticBoxSizer4->GetStaticBox(), ID_BUTTON_BROWSEHHC, _("Browse"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_BROWSEHHC"));
    ...
    StaticText6 = new wxStaticText(StaticBoxSizer4->GetStaticBox(), ID_STATICTEXT6, _("Path To Dot"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    BoxSizer13->Add(StaticText6, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPathDot = new wxTextCtrl(StaticBoxSizer4->GetStaticBox(), ID_TEXTCTRL_PATHDOT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PATHDOT"));
    ...
    ButtonBrowseDot = new wxButton(StaticBoxSizer4->GetStaticBox(), ID_BUTTON_BROWSEDOT, _("Browse"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_BROWSEDOT"));
    ...
    StaticText7 = new wxStaticText(StaticBoxSizer4->GetStaticBox(), ID_STATICTEXT7, _("Path To CHM Viewer"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
    BoxSizer19->Add(StaticText7, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    TextCtrlPathCHMViewer = new wxTextCtrl(StaticBoxSizer4->GetStaticBox(), ID_TEXTCTRL_PATHCHMVIEWER, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL_PATHCHMVIEWER"));
    ...
    ButtonBrowseCHMViewer = new wxButton(StaticBoxSizer4->GetStaticBox(), ID_BUTTON_BROWSECHMVIEWER, _("Browse"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_BROWSECHMVIEWER"));
    ...
    CheckBoxOverwriteDoxyfile = new wxCheckBox(StaticBoxSizer11->GetStaticBox(), ID_CHECKBOX_OVERWRITEDOXYFILE, _("Overwrite Doxyfile"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_OVERWRITEDOXYFILE"));
    ...
    CheckBoxPromptBeforeOverwriting = new wxCheckBox(StaticBoxSizer11->GetStaticBox(), ID_CHECKBOX_PROMPTB4OVERWRITING, _("Prompt Before Overwriting"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_PROMPTB4OVERWRITING"));
    ...
    CheckBoxUseAtInTags = new wxCheckBox(StaticBoxSizer11->GetStaticBox(), ID_CHECKBOX_USEATINTAGS, _("Use \"@\" In Tags"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_USEATINTAGS"));
    ...
    CheckBoxLoadTemplate = new wxCheckBox(StaticBoxSizer11->GetStaticBox(), ID_CHECKBOX_LOADTEMPLATE, _("Load Settings Template If No Saved Settings Exist"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_LOADTEMPLATE"));
    ...
    BoxSizer22->Add(CheckBoxLoadTemplate, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer11->Add(BoxSizer22, 0, wxEXPAND, 5);
    BoxSizer7->Add(StaticBoxSizer11, 0, wxEXPAND, 5);
    StaticBoxSizer12 = new wxStaticBoxSizer(wxVERTICAL, Panel1, _("HTML"));
    CheckBoxUseInternalViewer = new wxCheckBox(StaticBoxSizer12->GetStaticBox(), ID_CHECKBOX_USEINTERNALVIEWER, _("Use Internal Viewer"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_USEINTERNALVIEWER"));
    ...
    CheckBoxRunHTML = new wxCheckBox(StaticBoxSizer12->GetStaticBox(), ID_CHECKBOX_RUNHTML, _("Run HTML After Compilation"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_RUNHTML"));
    ...
    CheckBoxRunCHM = new wxCheckBox(StaticBoxSizer12->GetStaticBox(), ID_CHECKBOX_RUNCHM, _("Run CHM After Compilation"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_RUNCHM"));
