...
//
// ----------------------------------------------------------------------------
//  Commit 1.4.5 2023/04/12
//      Modded 1.4.5 T 2023/04/10
//      On "open as (<type)>" context menu, check for CB type files before
//          opening with mime type.
//      Force CB to add title to StartHerePage using menuId of save[project|workspace]
//      See: codesnippetstreectl EditSnippetWithMimeOrCB()
// ----------------------------------------------------------------------------
