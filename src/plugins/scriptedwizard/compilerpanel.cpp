    ...
    m_parentDialog(parentDialog)
{
	...
	StaticText3 = new wxStaticText(StaticBoxSizer1->GetStaticBox(), ID_STATICTEXT3, _("Output dir.:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	FlexGridSizer1->Add(StaticText3, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtDbgOut = new wxTextCtrl(StaticBoxSizer1->GetStaticBox(), ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
	FlexGridSizer1->Add(txtDbgOut, 1, wxEXPAND, 5);
	StaticText4 = new wxStaticText(StaticBoxSizer1->GetStaticBox(), ID_STATICTEXT4, _("Objects output dir.:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
	FlexGridSizer1->Add(StaticText4, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtDbgObjOut = new wxTextCtrl(StaticBoxSizer1->GetStaticBox(), ID_TEXTCTRL2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	...
	StaticText7 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT7, _("Output dir.:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	FlexGridSizer2->Add(StaticText7, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtRelOut = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL5, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
	FlexGridSizer2->Add(txtRelOut, 1, wxEXPAND, 5);
	StaticText8 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT8, _("Objects output dir.:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	FlexGridSizer2->Add(StaticText8, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtRelObjOut = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL6, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL6"));
